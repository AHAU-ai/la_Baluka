/**
 * popol-wuj-making-of-humans.ts — thin typed loader. The canon prose is the inert JSON in
...
export const ARC = loadArc(resolve(here, "canon/popol-wuj-making-of-humans.json"));
